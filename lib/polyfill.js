...
(function() {
	var identityMatrix = [1, 0, 0, 1, 0, 0],
		...
		theOriginalCanvas = canvas,
		theOriginalContext = context,
		canvasProto,
		contextProto,
	...
	if (!('currentTransform' in contextProto) || !('currentTransformInverse' in contextProto)) {
		...
		contextProto.restoreOriginal = function() {
			return theOriginalContext;
		};
		canvasProto.restoreOriginal = function() {
			return theOriginalCanvas;
		};
	}
